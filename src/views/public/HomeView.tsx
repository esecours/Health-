        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-8 space-y-6 relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <button
              ...
              className="px-6 py-4 bg-rose-600 hover:bg-rose-700 text-white font-black text-sm rounded-xl shadow-xl shadow-rose-900/20 transition-all flex items-center gap-2 cursor-pointer uppercase tracking-wider"
            >
              <ShieldAlert className="w-4 h-4 text-rose-200 animate-pulse" />
